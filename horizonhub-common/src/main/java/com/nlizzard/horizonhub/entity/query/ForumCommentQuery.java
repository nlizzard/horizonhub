package com.nlizzard.horizonhub.entity.query;


import com.nlizzard.horizonhub.entity.query.basequery.BaseQuery;
...
public class ForumCommentQuery extends BaseQuery {
    ...
    public List<Integer> getParentCommentIdList() {
        return parentCommentIdList;
    }

    public void setParentCommentIdList(List<Integer> pCommentIdList) {
        this.parentCommentIdList = pCommentIdList;
    }

    public Boolean getQueryIsLike() {
        return queryIsLike;
    }

    public void setQueryIsLike(Boolean queryIsLike) {
        this.queryIsLike = queryIsLike;
    }
